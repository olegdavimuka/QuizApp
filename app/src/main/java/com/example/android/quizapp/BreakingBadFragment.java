...
public class BreakingBadFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        QuestionCheckBox question_2 = new QuestionCheckBox();
        question_2.setAnswersLinearLayout((LinearLayout) rootView.findViewById(R.id.breakingBadQuestion_2_LinearLayout));
        List<Integer> question_2_CorrectAnswers = new ArrayList<>();
        for (int i : getResources().getIntArray(R.array.breakingBadQuestion_2_CorrectAnswersPositions))
            question_2_CorrectAnswers.add(i);
        question_2.setCorrectAnswersPositions(question_2_CorrectAnswers);
        question_2.setSubmitButton((Button) rootView.findViewById(R.id.breakingBadQuestion_2_SubmitButton));

        // QuestionRadioButton 3
        QuestionTextEntry question_3 = new QuestionTextEntry();
        question_3.setAnswerEditText((EditText) rootView.findViewById(R.id.breakingBadQuestion_3_EditText));
        question_3.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.breakingBadQuestion_3_PossibleAnswers)));
        ...
        question_4.setAnswerEditText((EditText) rootView.findViewById(R.id.breakingBadQuestion_4_EditText));
        question_4.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.breakingBadQuestion_4_PossibleAnswers)));
        ...
        question_5.setAnswersLinearLayout((LinearLayout) rootView.findViewById(R.id.breakingBadQuestion_5_LinearLayout));
        List<Integer> question_5_CorrectAnswers = new ArrayList<>();
        for (int i : getResources().getIntArray(R.array.breakingBadQuestion_5_CorrectAnswersPositions))
        ...
        QuestionRadioButton question_6 = new QuestionRadioButton();
        ...
        question_9.setAnswersLinearLayout((LinearLayout) rootView.findViewById(R.id.breakingBadQuestion_9_LinearLayout));
        List<Integer> question_9_CorrectAnswers = new ArrayList<>();
        for (int i : getResources().getIntArray(R.array.breakingBadQuestion_9_CorrectAnswersPositions))
        ...
        question_10.setAnswerEditText((EditText) rootView.findViewById(R.id.breakingBadQuestion_10_EditText));
        question_4.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.breakingBadQuestion_4_PossibleAnswers)));
