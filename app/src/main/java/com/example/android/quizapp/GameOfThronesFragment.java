...
public class GameOfThronesFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.game_of_thrones_layout, container, false);

        // Question 1
        Question question_1 = new Question(getString(R.string.gameOfThrones));
        question_1.setAnswersRadioGroup((RadioGroup) rootView.findViewById(R.id.gameOfThronesQuestion_1_AnswersRadioGroup));
        question_1.setCorrectAnswerRadioButton((RadioButton) rootView.findViewById(R.id.gameOfThronesQuestion_1_Answer_3_RadioButton));
        question_1.setSubmitButton((Button) rootView.findViewById(R.id.gameOfThronesQuestion_1_SubmitButton));

        // Question 2
        Question question_2 = new Question(getString(R.string.gameOfThrones));
        question_2.setAnswersRadioGroup((RadioGroup) rootView.findViewById(R.id.gameOfThronesQuestion_2_AnswersRadioGroup));
        question_2.setCorrectAnswerRadioButton((RadioButton) rootView.findViewById(R.id.gameOfThronesQuestion_2_Answer_2_RadioButton));
        question_2.setSubmitButton((Button) rootView.findViewById(R.id.gameOfThronesQuestion_2_SubmitButton));

        // Question 3
        Question question_3 = new Question(getString(R.string.gameOfThrones));
        ...
        // Question 4
        Question question_4 = new Question(getString(R.string.gameOfThrones));
        question_4.setAnswersRadioGroup((RadioGroup) rootView.findViewById(R.id.gameOfThronesQuestion_4_AnswersRadioGroup));
        question_4.setCorrectAnswerRadioButton((RadioButton) rootView.findViewById(R.id.gameOfThronesQuestion_4_Answer_1_RadioButton));
        question_4.setSubmitButton((Button) rootView.findViewById(R.id.gameOfThronesQuestion_4_SubmitButton));

        // Question 5
        Question question_5 = new Question(getString(R.string.gameOfThrones));
        ...
        // Question 6
        Question question_6 = new Question(getString(R.string.gameOfThrones));
        question_6.setAnswersRadioGroup((RadioGroup) rootView.findViewById(R.id.gameOfThronesQuestion_6_AnswersRadioGroup));
        question_6.setCorrectAnswerRadioButton((RadioButton) rootView.findViewById(R.id.gameOfThronesQuestion_6_Answer_1_RadioButton));
        question_6.setSubmitButton((Button) rootView.findViewById(R.id.gameOfThronesQuestion_6_SubmitButton));

        // Question 7
        Question question_7 = new Question(getString(R.string.gameOfThrones));
        ...
        // Question 8
        Question question_8 = new Question(getString(R.string.gameOfThrones));
        ...
        // Question 9
        Question question_9 = new Question(getString(R.string.gameOfThrones));
        question_9.setAnswersRadioGroup((RadioGroup) rootView.findViewById(R.id.gameOfThronesQuestion_9_AnswersRadioGroup));
        question_9.setCorrectAnswerRadioButton((RadioButton) rootView.findViewById(R.id.gameOfThronesQuestion_9_Answer_3_RadioButton));
        question_9.setSubmitButton((Button) rootView.findViewById(R.id.gameOfThronesQuestion_9_SubmitButton));

        // Question 10
        Question question_10 = new Question(getString(R.string.gameOfThrones));
