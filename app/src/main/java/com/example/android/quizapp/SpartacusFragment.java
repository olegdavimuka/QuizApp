...
public class SpartacusFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        question_4.setAnswerEditText((EditText) rootView.findViewById(R.id.spartacusQuestion_4_EditText));
        question_4.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.spartacusQuestion_4_PossibleAnswers)));
        ...
        question_6.setAnswerEditText((EditText) rootView.findViewById(R.id.spartacusQuestion_6_EditText));
        question_6.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.spartacusQuestion_6_PossibleAnswers)));
        question_6.setSubmitButton((Button) rootView.findViewById(R.id.spartacusQuestion_6_SubmitButton));

        // QuestionRadioButton 7
        QuestionCheckBox question_7 = new QuestionCheckBox();
        question_7.setAnswersLinearLayout((LinearLayout) rootView.findViewById(R.id.spartacusQuestion_7_LinearLayout));
        List<Integer> question_7_CorrectAnswers = new ArrayList<>();
        for (int i : getResources().getIntArray(R.array.spartacusQuestion_7_CorrectAnswersPositions))
            question_7_CorrectAnswers.add(i);
        question_7.setCorrectAnswersPositions(question_7_CorrectAnswers);
        question_7.setSubmitButton((Button) rootView.findViewById(R.id.spartacusQuestion_7_SubmitButton));

        // QuestionRadioButton 8
        QuestionTextEntry question_8 = new QuestionTextEntry();
        question_8.setAnswerEditText((EditText) rootView.findViewById(R.id.spartacusQuestion_8_EditText));
        question_8.setPossibleAnswers(Arrays.asList(getResources().getStringArray(R.array.spartacusQuestion_8_PossibleAnswers)));
        ...
        question_9.setAnswersLinearLayout((LinearLayout) rootView.findViewById(R.id.spartacusQuestion_9_LinearLayout));
        List<Integer> question_9_CorrectAnswers = new ArrayList<>();
        for (int i : getResources().getIntArray(R.array.spartacusQuestion_9_CorrectAnswersPositions))
            question_9_CorrectAnswers.add(i);
